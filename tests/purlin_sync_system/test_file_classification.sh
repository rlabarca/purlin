...
import sys, os
os.environ.setdefault('PURLIN_PROJECT_ROOT', os.environ['PURLIN_PROJECT_ROOT'])
...
assert_class "framework spec is SPEC" "SPEC" "features/framework_core/purlin_sync_system.md"
...
assert_class "shell script is CODE" "CODE" "hooks/scripts/write-guard.sh"
assert_class "agent definition is CODE" "CODE" "agents/purlin.md"
assert_class "skill file is CODE" "CODE" "skills/build/SKILL.md"
assert_class "test script is CODE" "CODE" "tests/purlin_sync_system/test_write_guard.sh"
