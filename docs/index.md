...
* [Constraints](constraints-guide.md) — How anchors and invariants flow through the build process, with the `purlin_constraints` tool and enforcement points.
...
* [File Format Specs](../references/formats/) — Canonical formats for features, anchors, companions, and invariants.
