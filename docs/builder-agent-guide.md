...
The Builder discovers its own work. At startup, it reads the Critic report, identifies features in TODO state, and proposes an implementation plan. You approve, and it begins.
