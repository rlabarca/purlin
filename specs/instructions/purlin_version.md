...
> Scope: VERSION, templates/config.json, .claude-plugin/plugin.json, .purlin/config.json, scripts/mcp/purlin_server.py, dev/bump_version.sh, skills/init/SKILL.md, references/drift_criteria.md
