...
> Description: The `purlin:spec` skill scaffolds or edits feature specs in 2-section format. It accepts any input — plain English, PRDs, customer feedback, code files, images — and extracts structured rules.
