...
- RULE-4: The skill names the three rule tags `[risk: ...]`, `[origin: ...]` and `[criterion: ...]` with their values, says risk and origin are both required under the `approved` gate, and names the four proof tiers and the three `@env` values [risk: medium] [origin: eng]
