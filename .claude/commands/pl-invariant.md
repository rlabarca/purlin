...
> **Invariant format:** See `instructions/references/invariant_format.md` for the canonical format.
> **Invariant model:** See `instructions/references/invariant_model.md` for identification, scope, and cascade rules.
...
8. **Run scan:** `${TOOLS_ROOT}/cdd/scan.sh` to integrate into dependency graph and trigger cascade if global.
...
8. **Run scan:** `${TOOLS_ROOT}/cdd/scan.sh` to cascade-reset dependent features.
...
8. **Run scan:** `${TOOLS_ROOT}/cdd/scan.sh` to trigger cascade (semver-gated per `instructions/references/invariant_model.md`):
...
6. **Run scan:** `${TOOLS_ROOT}/cdd/scan.sh` to update dependency graph.
