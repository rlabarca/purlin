...
2. Check the dependency graph (`.agentic_devops/cache/dependency_graph.json`) to identify all features that list `<name>` as a prerequisite. Present the impact list to the user.
