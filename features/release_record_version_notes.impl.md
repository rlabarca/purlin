...
**[DISCOVERY]** The inline copy of agent_instructions in `features/release_checklist_core.md` Section 2.7 still uses the old "Insert" wording. That file is Architect-owned and cannot be updated by the Builder. The authoritative source (`tools/release/global_steps.json`) is now correct. (Severity: HIGH)
