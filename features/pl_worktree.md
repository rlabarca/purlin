# Feature: /pl-worktree Worktree Management

> Label: "Agent Skills: Common: /pl-worktree Worktree Management"
...
The `/pl-worktree` command provides visibility into active, stale, and orphaned worktrees. Subcommands: `list` shows full detail for all worktrees, `cleanup-stale` removes worktrees whose agent has exited without merging.
...
#### Scenario: List shows active worktree
    ...
    When /pl-worktree list is invoked
...
#### Scenario: Cleanup removes stale worktree without uncommitted work
    ...
    When /pl-worktree cleanup-stale is invoked
