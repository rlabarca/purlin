...
*   The Step Detail Modal pattern references the Feature Detail Modal. If the Feature Detail Modal does not yet exist as an independent component, Engineer mode should implement the modal as a reusable component and refactor the Feature Detail Modal to use it.
...
**Suggested fix:** PM should update the visual spec line to say "4pt" to match design_modal_standards.
