...
- **Expected Behavior:** `/pl-help` detects role from the system prompt and displays the correct role-specific command table with `/pl-spec`, `/pl-anchor` (PM) or `/pl-build` (Engineer)
- **Action Required:** Engineer
- **Status:** RESOLVED
...
- **Observed Behavior:** PM startup outputs "I'm in PM mode. What would you like me to plan?" -- no Unicode border command table, no /pl-spec or /pl-anchor references.
