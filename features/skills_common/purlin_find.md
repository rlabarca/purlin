...
> Label: "Agent Skills: Common: purlin:find Topic Discovery"
...
#### Scenario: Topic found in existing feature spec
    ...
    When purlin:find is invoked with topic "authentication"
...
#### Scenario: Topic found only in instruction files
    ...
    When purlin:find is invoked with topic "commit discipline"
...
#### Scenario: Topic not found anywhere
    ...
    When purlin:find is invoked with topic "quantum computing"
