...
The Purlin agent does NOT print the command table at startup — it shows `Use purlin:help for commands` instead. `purlin:help` is the **sole owner** of command table display. It prints the unified command table and discovers user-facing CLI scripts on demand.
...
#### Scenario: Full help output displays both sections @auto
    ...
    When the user runs purlin:help
