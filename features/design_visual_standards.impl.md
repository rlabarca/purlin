...
|-----------|-------------------|-----|-----------|
| (see prose) | 246 FORBIDDEN pattern violations in shared CDD codebase. Acknowledged. | DISCOVERY | PENDING |
...
[DISCOVERY] 246 FORBIDDEN pattern violations in shared CDD codebase. Acknowledged.
