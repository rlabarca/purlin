...
*   **Fixture Tool Location:** `scripts/test_support/fixture.sh` — consumer-facing, submodule-safe. Implements checkout, cleanup, list, prune subcommands.
...
**Source:** purlin:spec-code-audit --deep (M32)
**Severity:** MEDIUM
