...
- **Steps 0-2 only** from `/pl-build`. Do NOT run Step 3 (verification) or Step 4 (status tags). The main Purlin session handles verification after merging all parallel branches.
