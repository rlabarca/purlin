...
- **2026-03-08:** Moved `agent_behavior_tests` from Phase 1 to Phase 2. Runner code fixed but cannot re-run (requires LLM API via `--write-results` flag). On-disk `tests.json` still uses old field names.
