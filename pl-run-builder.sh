...
# --- Deprecation warning ---
echo "============================================================" >&2
echo "DEPRECATED: pl-run-builder.sh is deprecated." >&2
echo "Use ./pl-run.sh instead. Examples:" >&2
echo "  ./pl-run.sh                  # Interactive Purlin agent" >&2
echo "  ./pl-run.sh --mode engineer  # Start in Engineer mode" >&2
echo "  ./pl-run.sh --auto-build     # Engineer mode + auto-start" >&2
echo "============================================================" >&2
